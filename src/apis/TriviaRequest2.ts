...
export class TriviaRequest2 {
    ...
    public async getAsync(url: string, args: any, session: builder.Session): Promise<any> {
    ...
    // tslint:disable-next-line:member-ordering
    public async delAsync(url: string, args: any, session: builder.Session): Promise<any> {
        // let args = await this.getAccessToken(session);
        // if (!args) {
        //     return null;
        // }
    ...
    // tslint:disable-next-line:member-ordering
    public async postAsync(url: string, args: any, session: builder.Session): Promise<any> {
        // let args = await this.getAccessToken(session);
        // if (!args) {
        //     return null;
        // }
    ...
    // tslint:disable-next-line:member-ordering
    public async putAsync(url: string, args: any, session: builder.Session): Promise<any> {
        // let args = await this.getAccessToken(session);
        // if (!args) {
        //     return null;
        // }
